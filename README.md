...
3. click the folder icon to open your `BetterDiscord/plugins` folder  
4. move or copy `bd-lowercase-ui.plugin.js` into that folder  
5. refresh the plugins page if needed, then toggle lowercase ui on
